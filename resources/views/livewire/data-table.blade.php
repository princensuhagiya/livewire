        ...
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <div class="max-w-lg">
                    ...
                    <div class="mt-2">
                        <input type="search" wire:model="search" name="search" id="search"
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    ...
                                    <div class="flex items-center text-left">
                                        ...
                                        <x-sort-ion field="name" :sortField="$sortField" :sortAsc="$sortAsc" />
                                    </div>
                                ...
                                <th scope="col">
                                    <div class="flex items-center text-left">
                                        <button type="button" wire:click="sortBy('email')"
                                            class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">
                                            Email</button>
                                        <x-sort-ion field="email" :sortField="$sortField" :sortAsc="$sortAsc" />
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="w-4/12 whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-0">
                                        <div class="flex items-center">
                                            <div class="ml-4">
